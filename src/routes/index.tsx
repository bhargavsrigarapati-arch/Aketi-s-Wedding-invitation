...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://naresh-gayatri-invitation.vercel.app/thumbnail.png" }
      { name="twitter:image", content="https://naresh-gayatri-invitation.vercel.app/thumbnail.png" }
    ],
  }),
});
